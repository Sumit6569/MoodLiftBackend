...
export const sendSessionRequestEmail = async (
  ...
  try {
    ...
    if (error.message.includes("timeout")) {
      ...
      console.error("   1. Gmail blocked the connection (security settings)");
      console.error("   2. Firewall blocking SMTP port (587/465)");
      console.error("   3. Network connectivity issues");
      console.error("   4. App password might be incorrect");
    }
...
export const sendSessionConfirmedEmail = async (
  ...
  try {
    ...
    if (error.message.includes("timeout")) {
      ...
      console.error("   4. App password might be incorrect");
      console.error(
        "💡 Consider using SendGrid instead of Gmail SMTP for deployments"
      );
    }
