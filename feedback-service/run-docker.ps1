# Feedback Service - Individual Docker Deployment Script (PowerShell)

$SERVICE_NAME = "feedback-service"
$IMAGE_NAME = "moodlift-feedback-service"
$CONTAINER_NAME = "moodlift-feedback-service"
$PORT = 3006

Write-Host "🚀 Deploying Feedback Service" -ForegroundColor Cyan
...
if ($runningContainer) {
    Write-Host "✅ Feedback Service is running!" -ForegroundColor Green
    ...
    Write-Host "❌ Failed to start Feedback Service" -ForegroundColor Red
