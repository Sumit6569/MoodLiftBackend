# Payment Service - Individual Docker Deployment Script (PowerShell)

$SERVICE_NAME = "payment-service"
$IMAGE_NAME = "moodlift-payment-service"
$CONTAINER_NAME = "moodlift-payment-service"
$PORT = 3004
...
if ($runningContainer) {
    ...
    Write-Host "❌ Failed to start Payment Service" -ForegroundColor Red
